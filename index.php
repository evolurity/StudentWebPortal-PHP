      ...
      <div class="container">
        <div class="row">
          <section class="content__left col-md-8">
            ...
            <div class="block">
              <a href="articles.php">Навигация по всем записям</a>
              <h3>Категория: Программирование</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">
                    <?php
                    $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id`=1");
                    ?>
                    <?php
                        while($art =  mysqli_fetch_assoc($articles)) {
                            ?>
            ...
            <div class="block">
              <a href="articles.php">Навигация по всем записям</a>
              <h3>Категория: Новости из мира IT</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">
                    <?php
                    $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id`=3");
                    ?>
                    <?php
                        while($art =  mysqli_fetch_assoc($articles)) {
                            ?>
            ...
            <div class="block">
              <a href="articles.php">Навигация по всем записям</a>
              <h3>Категория: Практика/Cтажировки</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">
                    <?php
                    $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id`=4");
                    ?>
                    <?php
                        while($art =  mysqli_fetch_assoc($articles)) {
                            ?>
            ...
            <div class="block">
              <a href="articles.php">Навигация по всем записям</a>
              <h3>Категория: Разное</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">
                    <?php
                    $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categories_id`=5");
                    ?>
                    <?php
                        while($art =  mysqli_fetch_assoc($articles)) {
                            ?>
